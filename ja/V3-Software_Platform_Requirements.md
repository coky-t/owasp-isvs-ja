...
| **3.4.13** | 2030 年を超えて運用することを予定しているデバイスにおいて、ファームウェアアップデート署名および検証メカニズムが耐量子デジタル署名 (ML-DSA, SLH-DSA) またはハイブリッド暗号方式をサポートし、長期的な真正性を確保していることを検証します。 | | | ✓ |
